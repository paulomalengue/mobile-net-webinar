...
export function Countdown() {
  ...
  const target = (() => {
    ...
    const year =
      now.getMonth() > 5 || (now.getMonth() === 5 && now.getDate() > 2)
        ? now.getFullYear() + 1
        : now.getFullYear();
  ...
  // evita diferença entre SSR e client
  ...
  return (
    <section className="relative py-20">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 text-center">
        ...
        <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gradient">O curso começa em</h2>
